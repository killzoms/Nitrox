...
namespace NitroxModel.DataStructures
{
    ...
    public class NitroxArray3<T> : IEnumerable<T>, IEnumerable
    {
        ...
        public NitroxArray3(int uniformSize)
            : this(uniformSize, uniformSize, uniformSize)
        {
        }

        public NitroxArray3(int sizeX, int sizeY, int sizeZ)
        {
            this.sizeX = sizeX;
            this.sizeY = sizeY;
            this.sizeZ = sizeZ;
        ...
        public void Set(NitroxInt3 int3, T value)
        {
            Set(int3.X, int3.Y, int3.Z, value);
        }
