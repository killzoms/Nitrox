...
namespace NitroxPatcher.Patches.Dynamic
{
    ...
    {
        private static readonly MethodInfo targetMethod = typeof(PilotingChair).GetMethod(nameof(PilotingChair.ReleaseBy), BindingFlags.Public | BindingFlags.Instance);
