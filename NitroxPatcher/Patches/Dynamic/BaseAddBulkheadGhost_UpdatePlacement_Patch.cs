...
namespace NitroxPatcher.Patches.Dynamic
{
    ...
    {
        private static readonly MethodInfo targetMethod = typeof(BaseAddBulkheadGhost).GetMethod(nameof(BaseAddBulkheadGhost.UpdatePlacement), BindingFlags.Public | BindingFlags.Instance);
