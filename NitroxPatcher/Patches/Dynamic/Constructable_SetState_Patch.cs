...
namespace NitroxPatcher.Patches.Dynamic
{
    ...
    {
        private static readonly MethodInfo targetMethod = typeof(Constructable).GetMethod(nameof(Constructable.SetState), BindingFlags.Public | BindingFlags.Instance);
        ...
        public static bool Prefix(Constructable __instance, bool value)
        {
            ...
            if (__instance.constructed && !value)
            {
                Optional<object> opId = TransientLocalObjectManager.Get(TransientLocalObjectManager.TransientObjectType.LATEST_DECONSTRUCTED_BASE_PIECE_GUID);
        ...
        public static void Postfix(Constructable __instance)
        {
            ...
            if (opId.HasValue)
            {
                TransientLocalObjectManager.Add(TransientLocalObjectManager.TransientObjectType.LATEST_DECONSTRUCTED_BASE_PIECE_GUID, null);
