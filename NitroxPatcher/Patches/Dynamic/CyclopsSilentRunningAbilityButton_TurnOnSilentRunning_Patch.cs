...
namespace NitroxPatcher.Patches.Dynamic
{
    ...
    {
        private static readonly MethodInfo targetMethod = typeof(CyclopsSilentRunningAbilityButton).GetMethod("TurnOnSilentRunning", BindingFlags.NonPublic | BindingFlags.Instance);
