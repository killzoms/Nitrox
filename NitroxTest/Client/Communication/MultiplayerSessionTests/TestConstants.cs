...
namespace NitroxTest.Client.Communication.MultiplayerSessionTests
{
    internal static class TestConstants
    {
        ...
        public const MultiplayerSessionReservationStates TEST_REJECTION_STATE = MultiplayerSessionReservationStates.REJECTED | MultiplayerSessionReservationStates.UNIQUE_PLAYER_NAME_CONSTRAINT_VIOLATED;
