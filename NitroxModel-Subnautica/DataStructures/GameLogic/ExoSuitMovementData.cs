...
namespace NitroxModel_Subnautica.DataStructures.GameLogic
{
    ...
    public class ExosuitMovementData : VehicleMovementData
    {
        ...
        public ExosuitMovementData(NitroxTechType techType, NitroxId id, NitroxVector3 position, NitroxQuaternion rotation, NitroxVector3 velocity, NitroxVector3 angularVelocity, float steeringWheelYaw, float steeringWheelPitch, bool appliedThrottle,
        ...
        {
            return $"[ExosuitMovementData - LeftAimTarget: {LeftAimTarget} RightAimTarget: {RightAimTarget} \n{base.ToString()}]";
        }
    }
}
